...
$edit_title = $_POST['post_title'];
$edit_category = $_POST['post_category'];
$edit_image = $_FILES['image']['name'];
$target = "Upload/".basename($_FILES['image']['name']);
$edit_content = $_POST['postDescription'];
$Admin = "Ivan";
...
global $ConnectingDB;
$query = ("INSERT INTO posts(post_datetime, post_title, post_category, post_author, post_image, post_content) VALUES('{$DateTime}', '{$edit_title}', '{$edit_category}', '{$edit_author}', '{$edit_image}', '{$edit_content}') ");
    ...
    <div class="card bg-secondary text-light mb-3">
        ...
        <div class="card-body bg-dark">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="post_title" id="title" value=" <?php echo $edit_title; ?> ">
            </div>
            <div class="form-group">
