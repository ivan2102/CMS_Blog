            ...
            <div class="col-lg-12">
                <table class="table table-striped table-hover">
                   ...
                   <tbody>
                    ...
                    <tr>
                    <td><?php echo $sr; ?></td>
                    <td><?php if(strlen($post_title)>20){$post_title = substr($post_title, 0,18).'..';} echo $post_title; ?></td>
                    <td><?php if(strlen($post_category)>8){$post_category = substr($post_category, 0,8).'..';} echo $post_category; ?></td>
                    <td><?php if(strlen($DateTime)>11){$DateTime = substr($DateTime, 0,11).'..';} echo $DateTime; ?></td>
                    <td><?php if(strlen($post_author)>6){$post_author = substr($post_author, 0,6).'..';} echo $post_author; ?></td>
